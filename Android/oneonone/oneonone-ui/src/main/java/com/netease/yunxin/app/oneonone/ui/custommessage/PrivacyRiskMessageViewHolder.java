...
public class PrivacyRiskMessageViewHolder extends ChatBaseMessageViewHolder {
  private static final String TAG = "PrivacyRiskMessageViewHolder";

  public PrivacyRiskMessageViewHolder(
  ...
  public void bindData(ChatMessageBean message, ChatMessageBean lastMessage) {
    ...
    View view =
        LayoutInflater.from(parent.getContext())
            .inflate(R.layout.one_on_one_chat_privacy_risk_holder, null);

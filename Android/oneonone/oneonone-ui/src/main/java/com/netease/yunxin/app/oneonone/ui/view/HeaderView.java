...
public class HeaderView extends LinearLayout implements RefreshHeader {
  ...
  private void initView(Context context) {
    ...
    LayoutInflater.from(context).inflate(R.layout.oneonone_refresh_header_layout, this);
  ...
  public void onStateChanged(
    ...
    if (newState == RefreshState.None || newState == RefreshState.PullDownToRefresh) {
      if (tvHeaderText != null) {
        tvHeaderText.setText(R.string.one_on_one_pull_to_refresh);
      }
    } else if (newState == RefreshState.Refreshing) {
      if (tvHeaderText != null) {
        tvHeaderText.setText(R.string.one_on_one_refreshing);
      }
    } else if (newState == RefreshState.ReleaseToRefresh) {
      if (tvHeaderText != null) {
        tvHeaderText.setText(R.string.one_on_one_release_to_refresh);
      }
    }
  }
}

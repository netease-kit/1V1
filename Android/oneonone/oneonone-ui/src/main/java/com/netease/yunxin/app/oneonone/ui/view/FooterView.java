...
public class FooterView extends LinearLayout implements RefreshFooter {
  ...
  private void initView(Context context) {
    ...
    LayoutInflater.from(context).inflate(R.layout.one_on_one_refresh_footer_layout, this);
  ...
  public boolean setNoMoreData(boolean noMoreData) {
    ...
    if (noMoreData) {
      if (tvFooter != null) {
        tvFooter.setText(context.getString(R.string.one_on_one_have_no_more));
      }
    }
    return true;
  }
  ...
  public void onStateChanged(
    ...
    if (newState == RefreshState.None || newState == RefreshState.PullDownToRefresh) {
      if (tvFooter != null) {
        tvFooter.setText(context.getString(R.string.one_on_one_load_more));
      }
    }
  }
}

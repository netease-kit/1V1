...
import com.netease.yunxin.app.one2one.databinding.ViewTitleBarBinding;
...
public class TitleBar extends ConstraintLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int backIconResId = typedArray.getResourceId(R.styleable.TitleBar_titleBar_back_icon, R.drawable.icon_left_arrow_dark);

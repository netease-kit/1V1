...
import com.netease.yunxin.app.one2one.databinding.FragmentInAudioCallBinding;
...
import com.netease.yunxin.app.one2one.ui.view.InTheAudioCallBottomBar;
...
public class InTheAudioCallFragment extends Fragment {
    ...
    private void subscribeUi() {
        ...
        pstnCallViewModel.getOtherRtcUid().observe(viewLifecycleOwner, new Observer<Long>() {
            @Override
            public void onChanged(Long aLong) {
                otherRtcUid = aLong;
            }
    ...
    private void initEvent() {
        binding.bottomBar.setOnItemClickListener(new InTheAudioCallBottomBar.OnItemClickListener() {
            @Override

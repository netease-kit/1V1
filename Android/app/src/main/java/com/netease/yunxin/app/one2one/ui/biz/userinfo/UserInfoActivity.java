...
public class UserInfoActivity extends BaseActivity {
  ...
  private void gotoCallPage(int channelType, boolean needPstnCall) {
    ...
    HttpService.searchUserInfoWithPhoneNumber(phoneNumber)
        .subscribe(
                ...
                if (userModelBaseResponse.isSuccessful() && userModelBaseResponse.data != null) {
                  LogUtil.i(
                      ...
                      "phoneNumber:"
                          + phoneNumber
                          + ",imAccid:"
                          + userModelBaseResponse.data.imAccid);
                  NavUtils.toCallPage(
                      UserInfoActivity.this, userModelBaseResponse.data, channelType, needPstnCall);
                } else {

...
public class HomeAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RvItemHomeBinding binding = RvItemHomeBinding.inflate(LayoutInflater.from(AppGlobals.getApplication()), parent, false);
    ...
    public static class HomeHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(HomeItemModel homeItemModel, int position) {
            ...
            ImageLoader.with(context).roundedCorner(homeItemModel.imageUrl, (int) DisplayUtils.dp2px( 4), binding.iv);
            binding.tv.setText(homeItemModel.nickName + " " + homeItemModel.age+"岁");

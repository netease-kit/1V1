...
public class MyRadioButton extends RadioButton {
    ...
    public MyRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.MyRadioButton_drawableSizes:
                    mDrawableSize = a.getDimensionPixelSize(R.styleable.MyRadioButton_drawableSizes,
                                                            50);//获取drawable大小，没设置时默认为50dp
                    break;
        ...
        a.recycle();
        setCompoundDrawablesWithIntrinsicBounds(drawableTop, drawableBottom, drawableLeft,
                                                drawableRight);//调用重写的方法进行设置drawable的大小.
    }

...
public class SettingActivity extends BaseActivity {
    ...
    private void initEvent() {
        binding.itemViewPrivacyPolicy.setOnItemClickListener(new SettingItemView.OnItemClickListener() {
            @Override
            public void onItemClick() {
                NavUtils.toBrowsePage(SettingActivity.this, SettingActivity.this.getString(R.string.privacy_policy), AppConstants.PRIVACY_POLICY);
            }
        });
        binding.itemViewUserAgreement.setOnItemClickListener(new SettingItemView.OnItemClickListener() {
            @Override
            public void onItemClick() {
                NavUtils.toBrowsePage(SettingActivity.this, SettingActivity.this.getString(R.string.user_agreement), AppConstants.USER_AGREEMENT);
            }
        });
        binding.itemViewAboutUs.setOnItemClickListener(new SettingItemView.OnItemClickListener() {
            @Override
            public void onItemClick() {
                NavUtils.toAppAboutPage(SettingActivity.this);
            }
        });
        binding.itemViewBindOtherAccount.setOnItemClickListener(new SettingItemView.OnItemClickListener() {
            @Override
            public void onItemClick() {
                NavUtils.toBindOtherPhonePage(SettingActivity.this);
            }
        });
        binding.itemViewPstn.setOnItemClickListener(new SettingItemView.OnItemClickListener() {
            @Override
            public void onItemClick() {

...
import com.netease.yunxin.app.oneonone.databinding.FragmentAppEntranceBinding;
  ...
  private void initView() {
    ...
    list.add(
        new FunctionAdapter.FunctionItem(
            getString(R.string.app_1v1),
            getString(R.string.app_1v1_desc),
            R.drawable.home_item_bg_1v1,
            R.raw.home_1v1,
            () -> {
              NavUtils.toOneOnOneHomePage(requireActivity());
            }));

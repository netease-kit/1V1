...
public class InTheVideoCallFragment extends Fragment {
    ...
    private void subscribeUi() {
        ...
        viewModel.getSecurityTipsModel().observe(viewLifecycleOwner, new Observer<SecurityTipsModel>() {
            @Override
        ...
        viewModel.getInTheCallDuration().observe(viewLifecycleOwner, new Observer<Long>() {
            @Override
            public void onChanged(Long aLong) {
                binding.tvDuration.setText(TimeUtil.formatSecondTime(aLong));
            }
        });
        viewModel.getRemoteVideoMute().observe(viewLifecycleOwner, new Observer<Boolean>() {
            @Override
        ...
        viewModel.getCallFinished().observe(viewLifecycleOwner, new Observer<Boolean>() {
            @Override
            public void onChanged(Boolean aBoolean) {
    ...
    private void handleBigVideoUi() {
        LogUtil.i(TAG, "handleBigVideoUi localVideoIsSmall:" + isSelfInSmallUi + ",localCameraIsOpen:" + localCameraIsOpen + ",remoteCameraIsOpen:" + remoteCameraIsOpen);
        if (!isSelfInSmallUi) {
            //大屏是自己
    ...
    private void handleSmallVideoUi() {
        LogUtil.i(TAG, "handleSmallVideoUi localVideoIsSmall:" + isSelfInSmallUi + ",localCameraIsOpen:" + localCameraIsOpen + ",remoteCameraIsOpen:" + remoteCameraIsOpen);
        if (isSelfInSmallUi) {
            //小屏是自己
    ...
    private void initEvent() {
        binding.flSmallVideo.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.flLocalCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (TextUtils.isEmpty(otherUid)){
                    return;
        ...
        binding.bottomBar.setOnItemClickListener(new InTheVideoCallBottomBar.OnItemClickListener() {
            @Override
        ...
        binding.ivEar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void handleMircoPhoneEvent() {
        ...
        if (muteLocal) {
            binding.bottomBar.getViewBinding().ivMicrophone.setImageResource(R.drawable.icon_microphone_mute);
        } else {

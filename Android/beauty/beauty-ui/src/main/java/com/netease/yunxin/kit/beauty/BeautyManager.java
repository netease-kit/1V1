...
import com.netease.yunxin.kit.beauty.module.NEBodyEffectEnum;
import com.netease.yunxin.kit.beauty.module.NEEffect;
import com.netease.yunxin.kit.beauty.module.NEEffectEnum;
import com.netease.yunxin.kit.beauty.module.NEFilter;
import com.netease.yunxin.kit.beauty.module.NEFilterEnum;
import java.io.File;
...
public class BeautyManager {
  ...
  public void setBeautyEffect(int resId, float level) {
    ...
    if (effect != null) {
      ...
      BeautyLogUtil.e(
          TAG, "setBeautyEffect-setBeautyEffect,type:" + effect.getType() + ",level:" + level);
    }
  }
  ...
  public void setBeautyBodyEffect(int resId, float level) {
    ...
    if (effect != null) {
      NERtcEx.getInstance().setBeautyEffect(effect.getType(), level);
      BeautyLogUtil.e(
          TAG, "setBeautyBodyEffect-setBeautyEffect,type:" + effect.getType() + ",level:" + level);
    }
  }
  ...
  public void addBeautyFilter(int resId, float level) {
    ...
    if (filter != null) {
      NERtcEx.getInstance()
          .addBeautyFilter(getBeautyAssetPath(NEAssetsEnum.FILTERS, filter.getName()));
      NERtcEx.getInstance().setBeautyFilterLevel(level);
      BeautyLogUtil.e(TAG, "addBeautyFilter-setBeautyFilterLevel" + ",level:" + level);
    }
  }
  ...
  public void resetEffect() {
    for (NEEffect effect : defaultEffects.values()) {
      ...
      BeautyLogUtil.e(
          TAG,
          "resetEffect-setBeautyEffect,type:" + effect.getType() + ",level:" + effect.getLevel());
    }
  }
  ...
  public void resetBodyEffect() {
    for (NEEffect effect : defaultBodyEffects.values()) {
      ...
      BeautyLogUtil.e(
          TAG,
          "resetBodyEffect-setBeautyEffect,type:"
              + effect.getType()
              + ",level:"
              + effect.getLevel());
    }
  ...
  public void resetFilter() {
    ...
    BeautyLogUtil.e(TAG, "resetBodyEffect-removeBeautyFilter");
  }

  public void startBeauty() {
    RtcUtil.configVideoConfig(BeautyConfig.VIDEO_PREVIEW_WIDTH, BeautyConfig.VIDEO_PREVIEW_HEIGHT);
    ...
    if (selectedFilter != null) {
      NERtcEx.getInstance()
          .addBeautyFilter(
              getBeautyAssetPath(
                  NEAssetsEnum.FILTERS, defaultFilters.get(selectedFilter.resId).getName()));
      NERtcEx.getInstance().setBeautyFilterLevel(selectedFilter.level);
      BeautyLogUtil.e(
          TAG,
          "startBeauty-addBeautyFilter,s:"
              + getBeautyAssetPath(
                  NEAssetsEnum.FILTERS, defaultFilters.get(selectedFilter.resId).getName()));
      BeautyLogUtil.e(TAG, "startBeauty-setBeautyFilterLevel,level:" + selectedFilter.level);
    }
  }

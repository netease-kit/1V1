...
module NEConversationUIKit
  ...
  def self.NOS_Special
    "NEConversationUIKit/NOS_Special"
  end
...
module NEAISearchKit
  ...
  def self.path
    "IMUIKit/NEAISearchKit/NEAISearchKit.podspec"
  end

  def self.install(pod)
    if NEAISearchKit.use_path
      puts "NEAISearchKit use path"
      pod.pod NEAISearchKit.name, :path => NEAISearchKit.path
    else
      puts "NEAISearchKit use http"
      pod.pod NEAISearchKit.name, NEAISearchKit.version
    end
  end
end

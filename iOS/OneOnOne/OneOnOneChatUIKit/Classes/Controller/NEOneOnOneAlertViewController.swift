...
public class NEOneOnOneAlertViewController: UIViewController {
  ...
  override public func viewDidLoad() {
    ...
    bgView.accessibilityIdentifier = "id.listDialogContentView"
  ...
  lazy var textView: UITextView = {
    ...
    view.text = content
    view.accessibilityIdentifier = "id.message"
    return view
  }()
  ...
  lazy var agreeButton: UIButton = {
    ...
    btn.accessibilityIdentifier = "id.agree"
    return btn
  }()
  ...
  lazy var disagreeButton: UIButton = {
    ...
    btn.addTarget(self, action: #selector(confirm(btn:)), for: .touchUpInside)
    btn.layer.cornerRadius = 22
    btn.accessibilityIdentifier = "id.cancel"
    return btn
  }()

...
public class NEOneOnOneReportView: UIView {
  ...
  func setUpSubViews() {
    ...
    lineView.snp.makeConstraints { make in
      ...
      make.top.equalTo(reportTableView.snp_bottom)
  ...
  lazy var cancelButton: UIButton = {
    ...
    cancelButton.setTitle(ne_localized("取消"), for: .normal)
    ...
    cancelButton.accessibilityIdentifier = "id.tvCancel"
    return cancelButton
  }()
...
class NEOneOnOneReportCell: UITableViewCell {
  ...
  lazy var contentLabel = {
    ...
    label.accessibilityIdentifier = "id.tv"
    return label
  }()
}

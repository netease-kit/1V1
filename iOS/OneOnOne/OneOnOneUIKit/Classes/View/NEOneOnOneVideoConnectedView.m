...
- (UILabel *)nameLabel {
  if (!_nameLabel) {
    ...
    _nameLabel.accessibilityIdentifier = @"id.nickName";
  }
  return _nameLabel;
}
- (UILabel *)timerLabel {
  if (!_timerLabel) {
    ...
    _timerLabel.accessibilityIdentifier = @"id.tvDuration";
  }
  return _timerLabel;
}
- (UIView *)localVideoView {
  if (!_localVideoView) {
    ...
    _localVideoView.accessibilityIdentifier = @"id.smallVideoView";
  }

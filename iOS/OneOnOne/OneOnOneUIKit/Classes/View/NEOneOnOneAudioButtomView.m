...
- (UIButton *)micButton {
  if (!_micButton) {
    ...
    _micButton.tag = 0;
    _micButton.accessibilityIdentifier = @"id.ivMicrophone";
  }
  return _micButton;
}
...
- (UIButton *)loudspeakerButton {
  if (!_loudspeakerButton) {
    ...
    _loudspeakerButton.accessibilityIdentifier = @"id.ivAudio";
  }
...
- (UIButton *)closeButton {
  if (!_closeButton) {
    ...
    [_closeButton addTarget:self
           ...
           forControlEvents:UIControlEventTouchUpInside];
    _closeButton.tag = 2;
    _closeButton.accessibilityIdentifier = @"id.hangupBtn";
  }
  return _closeButton;
}

...
- (UIButton *)chatUpButton {
  if (!_chatUpButton) {
    ...
    [_chatUpButton addTarget:self
            ...
            forControlEvents:UIControlEventTouchUpInside];
    _chatUpButton.accessibilityIdentifier = @"id.chatButton";
  }
...
- (UIButton *)privateLatterButton {
  if (!_privateLatterButton) {
    ...
    [_privateLatterButton addTarget:self
                   ...
                   forControlEvents:UIControlEventTouchUpInside];
    _privateLatterButton.accessibilityIdentifier = @"id.privateButton";
  }
...
- (UIButton *)audioButton {
  if (!_audioButton) {
    ...
    [_audioButton addTarget:self
                     action:@selector(clickAudio:)
           forControlEvents:UIControlEventTouchUpInside];
    _audioButton.accessibilityIdentifier = @"id.audioCallButton";
  }
  return _audioButton;
}
...
- (UIButton *)videoButton {
  if (!_videoButton) {
    ...
    [_videoButton addTarget:self
           ...
           forControlEvents:UIControlEventTouchUpInside];
    _videoButton.accessibilityIdentifier = @"id.videoCallButton";
  }
  return _videoButton;
}

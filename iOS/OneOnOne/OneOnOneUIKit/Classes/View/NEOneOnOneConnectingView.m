...
- (UIImageView *)remoteImageView {
  if (!_remoteImageView) {
    ...
    _remoteImageView.accessibilityIdentifier = @"id.ivAvatar";
  }
...
- (UILabel *)remoteNameLabel {
  if (!_remoteNameLabel) {
    ...
    _remoteNameLabel.accessibilityIdentifier = @"id.tvNick";
  }
...
- (UILabel *)connectingStatusLabel {
  if (!_connectingStatusLabel) {
    ...
    _connectingStatusLabel.accessibilityIdentifier = @"id.connectingStatus";
  }
...
- (UILabel *)connectingStatusDescLabel {
  if (!_connectingStatusDescLabel) {
    ...
    _connectingStatusDescLabel.accessibilityIdentifier = @"id.connectingStatusDesc";
  }
...
- (NEOneOnOneCustomButtonView *)cancelView {
  if (!_cancelView) {
    ...
    _cancelView.customLabel.accessibilityIdentifier = @"id.cancelText";
    _cancelView.customButton.accessibilityIdentifier = @"id.cancelBtn";
  }
  return _cancelView;
}
...
- (NEOneOnOneCustomButtonView *)rejectView {
  if (!_rejectView) {
    ...
    _rejectView.customLabel.accessibilityIdentifier = @"id.rejectText";
    _rejectView.customButton.accessibilityIdentifier = @"id.rejectBtn";
  }
  return _rejectView;
}
- (NEOneOnOneCustomButtonView *)acceptView {
  if (!_acceptView) {
    ...
    _acceptView.customLabel.accessibilityIdentifier = @"id.acceptText";
    _acceptView.customButton.accessibilityIdentifier = @"id.acceptBtn";
  }
  return _acceptView;
}

...
@implementation NEOneOnOneLocalized
...
+ (NSString *)ne_oneOnOneLocalizedStringForKey:(NSString *)key {
  return [self OneOnOneLocalizedStringForKey:key value:nil];
}

+ (NSString *)OneOnOneLocalizedStringForKey:(NSString *)key value:(NSString *)value {

...
extension NPTHomeViewController: UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    if let cell = tableView.dequeueReusableCell(withIdentifier: "NPTHomeCellIdentifier") as? NPTHomeCell {
      ...
      if indexPath.section == 0 {
        cell.backgroundImage.image = UIImage(named: "home_purple")
        cell.lottieView.animation = LottieAnimation.named("oneOnOne")
        cell.typeLabel.text = "One_On_One".localized
        cell.descriptionLabel.text = "One_On_One_Description".localized
